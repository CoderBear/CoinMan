package com.sbsgames.coinman.game;
...
public class CoinMan extends ApplicationAdapter {
    ...
    ArrayList<Rectangle> coinRects = new ArrayList<Rectangle>();
    int coinCount = 0;

    ArrayList<Integer> bombXs = new ArrayList<Integer>();
    ArrayList<Integer> bombYs = new ArrayList<Integer>();
    ArrayList<Rectangle> bombRects = new ArrayList<Rectangle>();
    int bombCount = 0;
    ...
    @Override
    // Draws back to front, the highest number is the top layer
    // 1 - background | 2 - Coin | 3 - Bomb | 4 - Man
    public void render() {
        batch.begin();
